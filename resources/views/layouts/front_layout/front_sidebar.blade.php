...
<div id="sidebar" class="span3">
				<div class="well well-small"><a id="myCart" href="{{ url('/cart') }}"><img src="{{ url('images/front_images/ico-cart.png') }}" alt="cart"><span class="totalCartItems">{{ totalCartItems() }}</span> Items in your cart</a></div>
                ...
                @if (isset($page_name) && $page_name=="listing")
                    ...
                    <div class="well well-small">
                        ...
                        @foreach ($occasionArray as $occasion)
                            <input  class="occasion" style="margin-top:-3px;" type="checkbox" name="occasion" id="{{ $occasion }}" value="{{ $occasion }}">&nbsp;&nbsp;{{ $occasion }}
                            <br>
                        @endforeach
                    </div>
                @endif
