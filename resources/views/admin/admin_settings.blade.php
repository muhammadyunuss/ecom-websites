            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" action="{{ url('/admin/update-current-pwd') }}" name="updatePasswordForm" id="updatePasswordForm">@csrf
               ...
               <?php /*<div class="form-group">
                    ...
                    <input class="form-control" id="admin_name" name="admin_name" value="{{ $adminDetails->name }}">
                  </div>*/ ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="current_pwd" name="current_pwd" required="" placeholder="Enter Current Password">
