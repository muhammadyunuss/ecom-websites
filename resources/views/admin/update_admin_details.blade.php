              ...
              <form role="form" method="post" action="{{ url('/admin/update-admin-details') }}" name="updateAdminDetails" id="updateAdminDetails" enctype="multipart/form-data">@csrf
               ...
               <?php /*<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="admin_name" name="admin_name" required="" placeholder="Masukan Nama Admin Disini" value="{{Auth::guard('admin')->user()->name}}">
                    <span id="chkCurrentPwd"></span>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Mobile</label>
                    <input type="text" class="form-control" id="admin_mobile" name="admin_mobile" required="" placeholder="Masukan Nomor Telepon" value="{{Auth::guard('admin')->user()->mobile}}">
                  </div>
                  <div class="form-group">
